...
import net.Byebye007x.firstprotomod.entity.animations.ModAnimationDefinitionsRhino;
...
public class RhinoModel<T extends Entity> extends HierarchicalModel<T> {
	...
	public static LayerDefinition createRhinoBodyLayer() {
	...
	public void setupAnim(T entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
		...
		this.animateWalk(ModAnimationDefinitionsRhino.RHINO_WALK, limbSwing, limbSwingAmount, 2f, 2.5f);
		this.animate(((RhinoEntity) entity).idleAnimationState, ModAnimationDefinitionsRhino.RHINO_IDLE, ageInTicks, 1f);
	}
