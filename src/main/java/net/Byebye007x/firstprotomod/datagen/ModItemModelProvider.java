...
public class ModItemModelProvider extends ItemModelProvider {
    ...
    protected void registerModels() {
        ...
        normalItem(ModItems.RAINBOW_ORB);
        ...
        handHeldItem(ModItems.SACRED_SWORD);
    ...
    private ItemModelBuilder normalItem(RegistryObject<Item> item) {
        return withExistingParent(item.getId().getPath(), new ResourceLocation("item/generated"))
                .texture("layer0", new ResourceLocation(ProtoMod.MOD_ID, "item/" + item.getId().getPath()));
    }
    ...
    private ItemModelBuilder ployScythe(RegistryObject<Item> item) {
        return withExistingParent(item.getId().getPath(), new ResourceLocation("item/handheld"))
                .texture("layer0", new ResourceLocation(ProtoMod.MOD_ID, "item/" + item.getId().getPath()))
                .transforms()
    ...
    private void trimmedArmorItem(RegistryObject<Item> itemRegistryObject) {
        final String MOD_ID = ProtoMod.MOD_ID;
    ...
    public void fenceItem (RegistryObject<Block> block, RegistryObject<Block> baseBlock){
        this.withExistingParent(ForgeRegistries.BLOCKS.getKey(block.get()).getPath(), mcLoc("block/fence_inventory"))
                .texture("texture", new ResourceLocation(ProtoMod.MOD_ID, "block/" + ForgeRegistries.BLOCKS.getKey(baseBlock.get()).getPath()));
    }
    ...
    private ItemModelBuilder normalBlockItem(RegistryObject<Block> item) {
