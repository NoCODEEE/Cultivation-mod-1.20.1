...
import net.Byebye007x.firstprotomod.screen.GemPolishingTable.GemPolishingTableScreen;
...
//        LOGGER.info("HELLO from server starting");
    ...
    public static class ClientModEvents {
        ...
        public static void onClientSetup(FMLClientSetupEvent event) {
            ...
            MenuScreens.register(ModMenuTypes.MANA_MANAGER_MENU.get(), ManaManagerScreen::new);
